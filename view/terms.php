...
<section class="section is-medium">
    <div class="container">
    <div id="placeholders">
      <h1 class="title">Terms and Conditions for <span class="highlight preview_company_name">Company Name</span></h1>
      <br/><h2 class="subtitle">Introduction</h2>
      ...
      <br/><h2 class="subtitle">Intellectual Property Rights</h2>
      ...
      <br/><h2 class="subtitle">Restrictions</h2>
      ...
      <br/><h2 class="subtitle">Your Content</h2>
      ...
      <br/><h2 class="subtitle">No warranties</h2>
      ...
      <br/><h2 class="subtitle">Limitation of liability</h2>
      ...
      <br/><h2 class="subtitle">Indemnification<p></p>
      ...
      </h2><br/><h2 class="subtitle">Severability</h2>
      <p>If any provision of these Terms is found to be invalid under any applicable law, such provisions shall be deleted without affecting the remaining provisions herein.</p>
      <br/><h2 class="subtitle">Variation of Terms</h2>
      ...
      <br/><h2 class="subtitle">Assignment</h2>
      ...
      <br/><h2 class="subtitle">Entire Agreement</h2>
      ...
      <br/><h2 class="subtitle">Governing Law &amp; Jurisdiction</h2>
